...
/* If VIN register is connected with battery, Low battery causes stripe issue during flash capture */
#if defined(CONFIG_MACH_BAFFINQ) || defined(CONFIG_MACH_CS05) || defined(CONFIG_MACH_GOLDEN)
	rt8547_send_data(0x01, 0x00); // Set VIN register limit as 3.0V
#else
	rt8547_send_data(0x01, 0x03); // Set VIN register limit as 3.3V
#endif
	return 0;
}
